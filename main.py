...
user_number_entry = tk.Entry(root, textvariable=user_number_var)
...
user_pin_entry = tk.Entry(root, text='PIN Number',
...
def remove_all_widgets():
	'''Function to remove all the widgets from the rootdow.'''
	global root
	for widget in root.rootfo_children():
		widget.grid_remove()
...
def create_login_screen():
	...
	root.rootfo_toplevel().title('FedUni Money Manager')
	...
	b1=Button(root, text="1", width=12, height=4)
	b1.grid(column=1, row=3)
	b1.bind('<Button-1>',handle_numpad)

	b2=Button(root, text="2", width=13, height=4)
	b2.grid(column=2, row=3)
	b2.bind('<Button-1>',handle_numpad)

	b3=Button(root, text="3", width=13, height=4)
	b3.grid(column=3, row=3)
	b3.bind('<Button-1>',handle_numpad)

	b4=Button(root, text="4", width=12, height=4)
	b4.grid(column=1, row=4)
	b4.bind('<Button-1>',handle_numpad)

	b5=Button(root, text="5", width=13, height=4)
	b5.grid(column=2, row=4)
	b5.bind('<Button-1>',handle_numpad)

	b6=Button(root, text="6", width=13, height=4)
	b6.grid(column=3, row=4)
	b6.bind('<Button-1>',handle_numpad)

	b7=Button(root, text="7", width=12, height=4)
	b7.grid(column=1, row=5)
	b7.bind('<Button-1>',handle_numpad)

	b8=Button(root, text="8", width=13, height=4)
	b8.grid(column=2, row=5)
	b8.bind('<Button-1>',handle_numpad)

	b9=Button(root, text="9", width=13, height=4)
	b9.grid(column=3, row=5)
	b9.bind('<Button-1>',handle_numpad)

	b0=Button(root, text="0", width=13, height=4)
	b0.grid(column=2, row=6)
	b0.bind('<Button-1>', handle_numpad)

	br=Button(root, text="clear", width=12, height=4, bg="red")
	br.grid(column=1, row=6)
	br.bind('<Button-1>',clear_pin_entry)

	bl=Button(root, text="Log In", width=13, height=4, bg="green")
	bl.grid(column=3, row=6)
	bl.bind('<Button-1>', log_in)
